        ...
        <div className="p-6 bg-gradient-to-br from-white to-blue-50">
          <div className="flex flex-col space-y-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">Manage how AI interacts with your sensitive data</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">{t('extension.dataProtection')}</h4>
                    <p className="text-xs text-gray-600">Prevent sensitive data from being shared with AI models</p>
                    <div className="mt-3 flex items-center">
                      <div className="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                        <input type="checkbox" name="toggle" id="toggle-1" className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 border-gray-300 appearance-none cursor-pointer" />
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex items-center">
                      <div className="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                        <input type="checkbox" name="toggle" id="toggle-2" className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 border-gray-300 appearance-none cursor-pointer" />
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">{t('extension.usageMonitoring')}</h4>
